...
public class WSLogin {
     ...
     */
    public void executeService(final String username,final String password) {
        final String url = WSConstants.BASE_URL + WSConstants.LOGIN;
        final String response = new WSUtil().callServiceHttpPost(url, generateLoginRequest(username,password));
     ...
     */
    @NonNull
    private RequestBody generateLoginRequest(final String username, final String password) {
        final WSConstants wsConstants = new WSConstants();
